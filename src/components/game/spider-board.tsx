...
export default function SpiderBoard(props: SpiderBoardProps) {
  ...
  return (
    <>
      ...
      <TableauPiles {...props} gridCols={gridCols} />
    </>
  );
}
...
const TableauPiles = ({ gameState, highlightedPile, handleCardClick, handleMouseDown, handleTouchStart, gridCols }: SpiderBoardProps & { gridCols: string }) => (
